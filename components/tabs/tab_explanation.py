...
def render_tab_explanation(tab: DeltaGenerator):
    tab.header('Explication des différents indicateurs')
    
    expander_1 = tab.expander("Le taux d'épargne")
    ...
    expander_2 = tab.expander("Le salaire net")
    ...
    expander_3 = tab.expander("Le salaire net imposable")
    ...
    expander_4 = tab.expander("Le salaire net après impôt")
    ...
    expander_5 = tab.expander("L'impôt sur le revenu")
    
    expander_5.markdown("""""")
    
    expander_4 = tab.expander("Le prélèvement à la source")
